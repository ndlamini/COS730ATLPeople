...
public class ResearchGroupAssociationImplementationTest 
{
	...
	public void createResearchGroupAssociationImplementationTest() throws Exception
	{
		...
		rgai2.setStartDate(myDate);
		rgai2.setEndDate(new Date());
	...
	public void testResearchGroupAssociationMethods()
	{
			...
			assertNotSame("Error get start and get end date cannot return the same date. these were set with different dates",rgai2.getStartDate(),rgai2.getEndDate());
			assertNotNull("Error :  failed to set start date",rgai2.getStartDate());
			assertNotNull("Error : falied to set end date ",rgai2.getEndDate() );
